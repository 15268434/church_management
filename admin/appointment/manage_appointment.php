...
<div class="container-fluid">
    <form action="" id="appointment-form">
        ...
        <div class="col-12">
            <h4>الطلب لـ: <?php echo $sched_type ?></h4>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="schedule" class="control-label">الجدول المطلوب</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="custom-select custom-select-sm rounded-0" required>
                            <option value="0" <?php echo (isset($status) && $status == 0) ? "selected" : "" ?>>قيد الانتظار</option>
                            <option value="1" <?php echo (isset($status) && $status == 1) ? "selected" : "" ?>>تم التأكيد</option>
                            <option value="2" <?php echo (isset($status) && $status == 2) ? "selected" : "" ?>>تم الإلغاء</option>
                        </select>
                    </div>
                </div>
            </div>
