...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">قائمة طلبات المواعيد</h3>
		<div class="card-tools">
			<a href="?page=appointment/manage_appointment" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  إضافة جديدة</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("هل أنت متأكد من رغبتك في حذف هذا الطلب بشكل دائم؟","delete_appointment_request",[$(this).attr('data-id')])
		})
		$('.edit_data').click(function(){
			uni_modal("إدارة طلب الموعد","appointment/manage_appointment.php?id="+$(this).attr('data-id'),'mid-large')
		})
