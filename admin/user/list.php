...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  إنشاء جديد</a>
        </div>
    </div>
    <div class="card-body">
...
<script>
    $(document).ready(function(){
        $('.delete_data').click(function(){
            _conf("هل أنت متأكد أنك تريد حذف هذا المستخدم نهائيًا؟","delete_user",[$(this).attr('data-id')])
        })
        $('.table').dataTable();
    })
