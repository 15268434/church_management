...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "تحديث ": "إنشاء حدث جديد " ?></h3>
	</div>
	<div class="card-body">
		<form action="" id="event-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
            <div class="form-group">
				<label for="schedule" class="control-label">تاريخ الجدول الزمني</label>
			...
			<div class="form-group">
				<label for="" class="control-label">صورة مصغرة</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="event-form">حفظ</button>
		<a class="btn btn-flat btn-default" href="?page=events">إلغاء</a>
	</div>
</div>
<script>
