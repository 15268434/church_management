...
<div class="card card-outline card-info">
		...
		<form action="" id="daily_verse-form">
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile">اختر ملفًا</label>
	            </div>
			</div>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="daily_verse-form">حفظ</button>
		<a class="btn btn-flat btn-default" href="?page=daily_verse">إلغاء</a>
	</div>
</div>
<script>
	...
	$(document).ready(function(){
		$('#daily_verse-form').submit(function(e){
			...
			$.ajax({
				...
				error:err=>{
					console.log(err)
					alert_toast("حدث خطأ أثناء الحفظ",'error');
					end_loader();
				},
