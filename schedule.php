...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <p><i>اختر نوع الموعد الذي ترغب في إنشاء طلب جدولة له.</i></p>
        <hr>
        <div class="col-12">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="ابحث هنا.." aria-label="ابحث هنا.." aria-describedby="basic-addon2" id="search">
        ...
        <div class="row gx-2 gx-lg-5 row-cols-1 row-cols-md-3 row-cols-xl-3 justify-content-center" id = 'sched-type-list'>
            ...
            <?php endwhile; ?>
            <center id="noResult" style="display:none"><b><i>لا توجد نتائج</i></b></center>
        </div>
    </div>
</section>
<script>
    $(function(){
        $('.sched-item').click(function(){
            ...
            uni_modal("إنشاء طلب موعد لـ "+name,"create_appointment.php?sched_type_id="+id,"mid-large")
        })
